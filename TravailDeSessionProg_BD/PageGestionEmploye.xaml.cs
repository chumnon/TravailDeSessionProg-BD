...
namespace TravailDeSessionProg_BD
{
    ...
    public sealed partial class PageGestionEmploye : Page
    {
        ...
        public PageGestionEmploye()
        {
            ...
            inEmploye.ItemsSource = SingletonEmploye.getInstance().GetListeEmployeSansTravail();
        }
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                leNumProjet = e.Parameter.ToString();
            }
        }
        ...
        private async void btAjoutTache_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (inEmploye.SelectedValue == null)
            {
            ...
            if (valide == true)
            {
                Employe selectedEmploye = (Employe)inEmploye.SelectedItem;

                Tache uneTache = new Tache
                {
                    NumTache = "",
                    LEmploye = selectedEmploye.Matricule.ToString(),
